...
import footerPhoto from "./../../assets/Icon-8x.png";
import { Link } from "react-router-dom";

const Footer = () => {
  return (
    <footer className="px-4 divide-y max-w-7xl mx-auto text-gray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="lg:w-1/3">
          ...
          >
            <div className="flex items-center justify-center w-12 h-12 rounded-full ml-4">
              <img className="w-[55px]" src={footerPhoto} alt="Career Craft Logo" />
            </div>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              {/* same icons but smaller (you can reuse above) */}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-6 text-sm text-center text-gray-600">
        Copyright © 2022. Career Craft all rights reserved
      </div>
    </footer>
  );
};
